...
public class DataAggregator {
	...
	public ArrayList<TrackerEntry_old> trackerData;  //important
	...
	public DataAggregator (double startTime, String file, double r, boolean binary, boolean control, boolean practice) {
		...
		trackerData = new ArrayList<TrackerEntry_old>();
	...
	//TRACKER ENTRIES
	//called from main game loop.
	public void addTrackerEntry (TrackerEntry_old t) {
		trackerData.add(t);
		if (!isPracticeRun) {
			printTrackerEntry(t);
		}
	...
	public void printTrackerEntry (TrackerEntry_old t) {
